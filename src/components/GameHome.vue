				...
				<div class="instructions">
					...
					<div>
						...
						>
							...
							<div>
								<i class="instruction-icon fas fa-users"></i>
								<p class="instructions-text">Create a Room or Join an existing room to play the game</p>
							</div>
							<div>
								<i class="instruction-icon fas fa-hourglass-start"></i>
								<p class="instructions-text">Wait for your friends to join and start the game</p>
							</div>
							<div>
							...
							<div>
								...
								<p class="instructions-text">Enjoy</p>
							</div>
						</vue-slick-carousel>
					</div>
				</div>
